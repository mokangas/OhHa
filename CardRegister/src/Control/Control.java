...
/**
 *
 * A mediator class between
 * <code>CardRegister</code> and the UI. This class also takes care of the
 * running of the program, i.e. this contains the main- method and the when the
 * constructor of this class is called, the program will start to run.
 *
 * @author mokangas
 */
public class Control {
    ...
    /**
     * The main-method. Constructs a new
     * <code>Control</code>-object, which launches the program.
     *
     * @param args Command line arguments, nothing is done with them.
     */
    public static void main(String[] args) {
        // The below will start GUI:
        Control control = new Control();
        // The below would launch the program in a text based Interface
    ...
    /**
     * Constructor. Sets up th business logic and the GUI and starts the
     * program.
     */
    public Control() {
    ...
    /**
     * Constructor which starts the text based consol interface.
     *
     * @deprecated
     * @param text This parameter is just to separate form the more useful
     * GUIconstructor.
     */
     ...
     * @throws cardregister.CardRegisterExceptions.NullInputException If the
     * data of the card added contains at most emptyspaces.
     ...
     * @throws cardregister.CardRegisterExceptions.CardAlreadyExistsException If
     * there already is exactly the same card in the register. The addition of
     ...
     *
     * @param oldData The data of the card to be edited. This is used to
     * indetify the card.
     ...
     * existing card.
     * @throws cardregister.CardRegisterExceptions.NullInputException If the new
     * data contains at most emptyspaces.
     * @throws cardregister.CardRegisterExceptions.CardAlreadyExistsException If
     * there already is exactly similar card. The point of this exception is
    ...
    /**
     * Retrieves the number of the text field whose content is meant to be the
     * name of the card.
     *
